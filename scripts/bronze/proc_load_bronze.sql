...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Script Purpose:
  This stored procedure loads data into the 'bronze' schema from the external CVS files.
  It performes the following tasks:
   + Truncates the bronze tables before loading data.
   + Uses the 'Bulk Insert' command to load data from CVS files to bronze tables.

Parameters:
  None.
This stored procedure does not accept any parametere or return any values.
